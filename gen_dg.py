...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, help='path of dataset', default="configs/qm9_default.yml")
    ...
    parser.add_argument('--tag', type=str, default='qm9_test')
    parser.add_argument('--num_confs', type=num_confs, default=num_confs('2x'))
    parser.add_argument('--test_set', type=str, default=None)
    # parser.add_argument('--init_checkpoint', type=str, default='log/dg/checkpoints/qm9/729')
    ...
    parser.add_argument('--w_dg', type=float, default=0,
    ...
    output_dir = gen_log_dir(log_dir, args.w_dg, args.seed, args.tag)
    # output_dir = "log/"
