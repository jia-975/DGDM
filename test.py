...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, help='path for loading the checkpoint', default="log/geodiff/checkpoints/drugs_default.pt")
    ...
    parser.add_argument('--w_ip', type=float, default=0.1,
                    help='weight for global gradients')
    # Parameters for DDPM
    ...
    config_path = "configs/drugs_default.yml"
    ...
    output_dir = get_new_log_dir(log_dir, 'sample_ip', tag=args.tag)
