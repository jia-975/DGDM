...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, help='path of dataset', default="bash_sde/drugs_ema_discriminator.yml")
    ...
    solver = runner.DefaultRunner(train_dataset, val_data, test_dataset, None, model, optimizer, scheduler, gpus, config)
